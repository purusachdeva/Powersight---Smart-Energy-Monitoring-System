...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = '/home/ec2-user/extreme-unison-443418-e6-15c860136091.json'
...
def main():
    mypath = "/home/ec2-user/cropped_images/"
    only_files = [f for f in listdir(mypath) if isfile(join(mypath, f))]
    
    output_csv = "/home/ec2-user/output.csv"
